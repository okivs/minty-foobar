...
seekbar.c1 = window.GetColourCUI(5); // bg color - 'Selected Item background' in CUI
seekbar.c2 = window.GetColourCUI(4); // bar color - 'Item foreground' in CUI
...
function on_colours_changed() {
    seekbar.c1 = window.GetColourCUI(5);
    seekbar.c2 = window.GetColourCUI(4);
    window.Repaint();
}
