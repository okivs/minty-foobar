...
oScrollbar = function (themed) {
	...
	this.setButtons = function () {
		...
		try {
			...
			gb.DrawString(String.fromCharCode(9650), g_font_wd3_scrollBar, g_color_normal_txt & 0x55ffffff, 0, 0, this.w, this.w, cc_stringformat);
		};
		...
		try {
			...
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9650), g_font_wd3_scrollBar, g_color_normal_txt & 0x99ffffff, 0, 0, this.w, this.w, cc_stringformat);
		};
		...
		try {
			...
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9650), g_font_wd3_scrollBar, g_color_normal_txt, 0, 0, this.w, this.w, cc_stringformat);
		};
		...
		try {
			...
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9660), g_font_wd3_scrollBar, g_color_normal_txt & 0x55ffffff, 0, 0, this.w, this.w, cc_stringformat);
		};
		...
		try {
			...
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9660), g_font_wd3_scrollBar, g_color_normal_txt & 0x99ffffff, 0, 0, this.w, this.w, cc_stringformat);
		};
		...
		try {
			...
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9660), g_font_wd3_scrollBar, g_color_normal_txt, 0, 0, this.w, this.w, cc_stringformat);
		};
	...
	this.setButtons = function () {
		...
		if (this.themed) {
			try {
				...
				gb.SetTextRenderingHint(4);
				gb.DrawString(String.fromCharCode(9650), g_font_wd3_scrollBar, this.color_txt & 0x55ffffff, 0, 0, this.w, this.w, cc_stringformat);
			};
		} else {
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9650), g_font_wd3_scrollBar, this.color_txt & 0x55ffffff, 0, 0, this.w, this.w, cc_stringformat);
		...
		if (this.themed) {
			try {
				...
				gb.SetTextRenderingHint(4);
				gb.DrawString(String.fromCharCode(9650), g_font_wd3_scrollBar, this.color_txt & 0x99ffffff, 0, 0, this.w, this.w, cc_stringformat);
			};
		} else {
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9650), g_font_wd3_scrollBar, this.color_txt & 0x99ffffff, 0, 0, this.w, this.w, cc_stringformat);
		...
		if (this.themed) {
			try {
				...
				gb.SetTextRenderingHint(4);
				gb.DrawString(String.fromCharCode(9650), g_font_wd3_scrollBar, this.color_txt, 0, 0, this.w, this.w, cc_stringformat);
			};
		} else {
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9650), g_font_wd3_scrollBar, this.color_txt, 0, 0, this.w, this.w, cc_stringformat);
		...
		if (this.themed) {
			try {
				...
				gb.SetTextRenderingHint(4);
				gb.DrawString(String.fromCharCode(9660), g_font_wd3_scrollBar, this.color_txt & 0x55ffffff, 0, 0, this.w, this.w, cc_stringformat);
			};
		} else {
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9660), g_font_wd3_scrollBar, this.color_txt & 0x55ffffff, 0, 0, this.w, this.w, cc_stringformat);
		...
		if (this.themed) {
			try {
				...
				gb.SetTextRenderingHint(4);
				gb.DrawString(String.fromCharCode(9660), g_font_wd3_scrollBar, this.color_txt & 0x99ffffff, 0, 0, this.w, this.w, cc_stringformat);
			};
		} else {
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9660), g_font_wd3_scrollBar, this.color_txt & 0x99ffffff, 0, 0, this.w, this.w, cc_stringformat);
		...
		if (this.themed) {
			try {
				...
				gb.SetTextRenderingHint(4);
				gb.DrawString(String.fromCharCode(9660), g_font_wd3_scrollBar, this.color_txt, 0, 0, this.w, this.w, cc_stringformat);
			};
		} else {
			gb.SetTextRenderingHint(4);
			gb.DrawString(String.fromCharCode(9660), g_font_wd3_scrollBar, this.color_txt, 0, 0, this.w, this.w, cc_stringformat);
