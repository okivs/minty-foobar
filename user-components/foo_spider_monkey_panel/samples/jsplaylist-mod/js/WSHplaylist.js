...
oItem = function (playlist, row_index, type, handle, track_index, group_index, track_index_in_group, heightInRow, groupRowDelta, obj, empty_row_index) {
	...
	this.draw = function (gr, x, y, w, h) {
		...
		case 1:
			...
			this.l1_color = blendColors(g_color_normal_txt, blendColors(g_color_normal_txt, color_txt, 1), 1);
			this.l2_color = blendColors(g_color_normal_txt, blendColors(g_color_normal_bg, color_txt, 0.80), 1);
					...
					if (this.heightInRow > 1 && cover.show) {
						...
						if (typeof this.cover_img != "undefined") {
							...
							if (this.cover_img) {
								...
								// gr.DrawRect(cv_x, cv_y, cv_w, cv_h, 2.0, RGB(255, 255, 255)); --> Editing this out to remove the white border around cover art / album art
							};
						} else {
							gr.DrawImage(images.loading, cv_x - 2, cv_y - 2, cv_w, cv_h, 0, 0, images.loading.Width, images.loading.Height, images.loading_angle, 225);
						};
...
oList = function (object_name, playlist) {
	...
	this.setItemColors = function () {
		this.text_colour_playing = blendColors(g_color_highlight, g_color_normal_bg, 0);
		this.text_colour_selected = blendColors(g_color_selected_txt, g_color_normal_bg, 0);
